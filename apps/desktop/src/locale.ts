...
export const en = {
  ...
  startupFailed: '维小智 is unavailable',
  ...
  updateDownloadedTitle: '维小智 v{version} downloaded',
  ...
  // fork: 企业登录窗（renderer/login.html）的文案；zh 必须提供同一组键。
  enterpriseLoginWindowTitle: '维小智 — Sign in',
  loginBrandMark: '维',
  loginBrandName: '维小智',
  loginHeading: 'Sign in to 维小智',
  loginDescription: 'Use your enterprise account. The workspace opens after sign-in.',
  ...
  loginSuccess: 'Signed in. Opening workspace…',
  loginWelcome: 'Welcome back',
  loginInternalBadge: 'Internal',
  loginFooter: 'Your tasks and files stay on this computer.',
} as const
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: '维小智 v{version} 下载完成',
  ...
  // fork: 企业登录窗（renderer/login.html）的文案。
  enterpriseLoginWindowTitle: '维小智 — 登录',
  loginBrandMark: '维',
  loginBrandName: '维小智',
  loginHeading: '登录维小智',
  loginDescription: '请使用企业账号登录，登录成功后进入工作区。',
  loginEnvironment: '环境',
  loginEmail: '邮箱',
  loginPassword: '密码',
  ...
  loginSubmit: '登 录',
  loginSubmitting: '登录中…',
  loginSuccess: '登录成功，正在进入工作区…',
  loginWelcome: '欢迎回来',
  loginInternalBadge: '内部',
  loginFooter: '任务与文件都保存在本机。',
