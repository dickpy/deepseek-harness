...
export const en = {
  ...
  startupFailed: '维小智 could not start',
  startupLoading: 'Starting 维小智…',
  ...
  pluginWindowTitle: '维小智 — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: '维小智 无法启动',
  startupLoading: '正在启动 维小智…',
