...
/**
 * fork: Third-party plugins shipped inside the Desktop runtime, pinned to the
 * exact versions the runtime project installs from the npm registry. Each is a
 ...
 * plugins. The web template leads, then the 维小智 enterprise plugin, then the
 * bundled registry plugins.
 */
