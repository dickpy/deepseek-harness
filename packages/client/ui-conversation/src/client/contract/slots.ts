...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * fork: Module catalog staged for a New Session (WorkBuddy-style category
     * tabs plus skill chips), rendered between the greeting and the composer.
     ...
     * push the input box down. Session-maybe seat like the catalog: picking a
     * case fills the draft with `/<skill> <prompt>`, so the occupant needs the
     * same input faces and disables picking when there is no Session.
     */
